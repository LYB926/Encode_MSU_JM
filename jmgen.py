def generate(path, name, frameNumber, frameRate, width, height, qp):

    fileName = name + '_' + qp + '.cfg'
    ...
    '''
    file.write(cfg1)
    file.write('InputFile             = \"' + path + name + ".yuv" + '\"')
    ...
    '''
    file.write(cfg2)
    para1 = 'FramesToBeEncoded     = ' + frameNumber + '     # Number of frames to be coded\n'
    para2 = '    FrameRate             = ' + frameRate + '  # Frame Rate per second (0.1-100.0)'
    ...
    para3 = 'SourceWidth           = ' + width + '    # Source frame width\n    SourceHeight          = ' + height + '    # Source frame height\n    SourceResize          = 0       # Resize source size for output\n    OutputWidth           = ' + width + '    # Output frame width\n    OutputHeight          = ' + height + '    # Output frame height'
    file.write(para3)
    ...
    file.write('    OutputFile            = "' + path + name + '_' + qp + '.264' + '"           # Bitstream\n    ')
    ...
    PSliceSearch4x4       = 0   # P-Slice Inter block search  4x4  (0=disable, 1=enable)
    ...
    BSliceSearch8x4       = 0   # B-Slice Inter block search  8x4  (0=disable, 1=enable)
    BSliceSearch4x8       = 0   # B-Slice Inter block search  4x8  (0=disable, 1=enable)
    BSliceSearch4x4       = 0   # B-Slice Inter block search  4x4  (0=disable, 1=enable)

    BiPredSearch16x16     = 1   # B-Slice Bi-prediction block search 16x16 (0=disable, 1=enable)
    BiPredSearch16x8      = 0   # B-Slice Bi-prediction block search 16x8  (0=disable, 1=enable)
    BiPredSearch8x16      = 0   # B-Slice Bi-prediction block search 8x16  (0=disable, 1=enable)
    ...
    DistortionSSIM         =  1  # Compute SSIM distortion. (0: disabled/default, 1: enabled)
